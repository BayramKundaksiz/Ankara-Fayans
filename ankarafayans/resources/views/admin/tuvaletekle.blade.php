                        ...
                        <div class="card w-100">
                            <div class="card-body">
                                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                    ...
                                    <form action="{{ route('tuvaleteklendi') }}" method="post"
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="tuvalet_baslik"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="tuvalet_aciklama" aria-describedby="textHelp">
                                                    </div>
                                                </div>
                                            </div>
                                            <h5 class="card-title mb-9 fw-semibold">Tuvalet Fotoğrafı</h5>
                                            <div class="row align-items-center">

                                                <div class="card card-body">
                                                    <label>Görsel Seç :</label>
                                                    <input type="file" name="tuvalet_gorseli" required="">
                                                </div>
