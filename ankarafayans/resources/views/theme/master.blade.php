...
<body>
    ...
    @include('theme.textslider')

    @include('theme.services')

    @include('theme.center')

    @include('theme.promotionone')

    @include('theme.promotiontwo')

    @include('theme.examplegalleries')

    @include('theme.bestwork')

    @include('theme.countnumbers')
